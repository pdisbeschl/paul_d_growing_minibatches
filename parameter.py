...
def get_parameters():
    ...
    parser.add_argument('--batch_s_doubler', nargs = "+", type=int, default=-1) #at which step to double batch_size
    ...
    parser.add_argument('--dataset', type=str, default='cifar10',
                        choices=['imagenet', 'cifar10', 'lsun', 'svhn', 'flower'])
    ...
    parser.add_argument('--eval_step', type=int, default=50000) #once per epoch
    ...
    parser.add_argument('--srfb', type=str2bool, default=False, help='Use the SRFB')
